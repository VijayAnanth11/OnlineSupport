        ...
        <div class="card col-12 col-sm-6">
            ...
            <div class="card-body">
                ...
                <div class="form-group mb-2">
                    ...
                    <textarea class="form-control form-control-sm" placeholder="" required name="problem" id="problem"
                        disabled>{{$item->problem}}</textarea>
                </div>
                <div class="form-group mb-2">
                ...
                <div class="form-group mb-2">
                    ...
                    <textarea class="form-control form-control-sm" name="reply" id="reply"
                        disabled>{{$item->reply}}</textarea>
                </div>
                <div class="form-group mb-2">
                    <label style="font-weight:bold">Status</label>
                    @if( $item->status === 'pending')
                    <input type="text" class="form-control form-control-sm" placeholder="" required name="status"
                        id="status" value="{{$item->status}}" disabled style="color:red; font-weight:bold">
                    @endif

                    @if( $item->status === 'in process')
                    <input type="text" class="form-control form-control-sm" placeholder="" required name="status"
                        id="status" value="{{$item->status}}" disabled style="color:blue; font-weight:bold">
                    @endif

                    @if( $item->status === 'closed')
                    <input type="text" class="form-control form-control-sm" placeholder="" required name="status"
                        id="status" value="{{$item->status}}" disabled style="color:black; font-weight:bold">
                    @endif
                </div>
